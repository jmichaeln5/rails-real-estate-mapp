...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { email: @seller.email, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { email: @seller.email, password: 'secret', password_confirmation: 'secret' } }
