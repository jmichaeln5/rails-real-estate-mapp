...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { email: @buyer.email, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { email: @buyer.email, password: 'secret', password_confirmation: 'secret' } }
